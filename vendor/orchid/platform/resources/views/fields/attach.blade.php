@component($typeForm, get_defined_vars())
    ...
    >
        ...
        <template data-attach-target="template">
            <div class="pip col position-relative gallery-item">
                <input type="hidden" name="{name}" value="{id}">

                <a href="{url}"  data-lightbox="images">
                <img class="attach-image rounded border user-select-none overflow-hidden" src="{url}" onclick="openModal('{url}')" title="{original_name}"/>
                </a>
